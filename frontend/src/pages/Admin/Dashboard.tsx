...
import { FaShoppingCart, FaDollarSign, FaUsers, FaBox, FaChartBar } from 'react-icons/fa';
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <Link to="/admin/products" className="bg-white rounded-lg shadow-md p-6 text-center hover:shadow-lg transition-shadow">
        ...
        <Link to="/admin/orders" className="bg-white rounded-lg shadow-md p-6 text-center hover:shadow-lg transition-shadow">
        ...
        <Link to="/admin/users" className="bg-white rounded-lg shadow-md p-6 text-center hover:shadow-lg transition-shadow">
